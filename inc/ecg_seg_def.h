...
#define ECG_SIGNAL_TRAN_MID0_OUTPUT_C                                 (8)
#define ECG_SIGNAL_TRAN_MID0_OUTPUT_IND                               (8)
#define ECG_SIGNAL_DECODER_MID0_INPUT_C                               (12)
#define ECG_SIGNAL_DECODER_MID0_INPUT_IND                             (4)
#define ECG_SIGNAL_DECODER_MID0_0_OUTPUT_C                            (4)
#define ECG_SIGNAL_DECODER_MID0_0_OUTPUT_IND                          (0)
#define ECG_SIGNAL_DECODER_MID0_1_OUTPUT_C                            (4)
#define ECG_SIGNAL_DECODER_MID0_1_OUTPUT_IND                          (4)
